...
const MX_COVERAGE_OVERRIDES = Object.freeze({
  ...
  'SAM-25006': { coverage: 'partial', spec: 'tests/s1/mx/qst/base-store/rewards-payment-registered-safe.spec.js', test: 'SAM-25006 - Rewards payment mode is available and selectable', notes: 'Rewards payment selection is automated but depends on an eligible authenticated account/balance; no fake availability is reported.' },
