...
- Checkout pre-submit: `npx playwright test tests/s2/pe/dst/base-store/checkout/checkout.spec.js --project=chromium --workers=1 --headed`
- Payment read-only: `npx playwright test tests/s2/pe/dst/base-store/payment/payment.spec.js --project=chromium --grep-invert "@destructive" --workers=1 --headed`
